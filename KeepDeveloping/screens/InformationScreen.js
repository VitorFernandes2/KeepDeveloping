  ...
  return (
    <View style={styles.containerMain}>
      ...
      <View style={styles.containerText}>
        <Text
          style={[styles.bodyText, { paddingBottom: 10, textAlign: "center" }]}
        >
          Developed for MDS by:
        </Text>
        ...
        <Text style={styles.bodyText}>Luís Silva</Text>
        <Text style={styles.bodyText}>Rui Neves</Text>
        <Text style={styles.bodyText}>Vítor Fernandes</Text>
      </View>
