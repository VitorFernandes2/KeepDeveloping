...
const DifficultiesScreen = (props) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <View>
            <DifficultyBadge name={"Fácil"} greenStars={1} questions={easy} randomOrder={randomOrderGenerator(easy)} />
        </View>
        <View>
            <DifficultyBadge name={"Médio"} greenStars={2} questions={medium} randomOrder={randomOrderGenerator(medium)} />
        </View>
        <View>
            <DifficultyBadge name={"Dificil"} greenStars={3} questions={hard} randomOrder={randomOrderGenerator(hard)} />
        </View>
    </View>
  );
};
